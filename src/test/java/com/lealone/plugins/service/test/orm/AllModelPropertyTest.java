 ...
 */
package com.lealone.plugins.service.test.orm;
...
import com.lealone.db.api.JavaObjectSerializer;
...
import com.lealone.plugins.service.test.orm.generated.AllModelProperty;
import com.lealone.plugins.service.test.service.generated.AllTypeService;

public class AllModelPropertyTest {
    ...
    public static AllModelProperty create(Integer f1, Boolean f2, Byte f3, Short f4, Long f5, Long f6,
            BigDecimal f7, Double f8, Float f9, Time f10, Date f11, Timestamp f12, byte[] f13,
            Object f14, String f15, String f16, String f17, Blob f18, Clob f19, UUID f20, Array f21) {
    ...
    public static void insertRemote(AllTypeService allTypeService) {
        ...
        allTypeService.testType(f1, f2, f3, f4, f5, f6, f7, f8, f9, f10, f11, f12, f13, f14, f15, f16,
                f17, f18, f19, f20, f21);
    }
}
